...
export function TenantDirectory() {
  ...
  return (
    <div className="tenants-shell">
      ...
      <nav className="bottom-nav tenants-bottom-nav" aria-label="Mobile navigation"><Link href="/">⌂<span>Dashboard</span></Link><Link href="/rooms">▦<span>Rooms</span></Link><Link className="active" href="/tenants">♙<span>Tenants</span></Link><Link href="/">₹<span>Finance</span></Link></nav>
