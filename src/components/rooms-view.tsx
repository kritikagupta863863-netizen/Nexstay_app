...
export function RoomsView() {
  ...
  return (
    <div className="rooms-shell">
      ...
      <nav className="bottom-nav rooms-bottom-nav" aria-label="Mobile navigation"><Link href="/">⌂<span>Dashboard</span></Link><Link className="active" href="/rooms">▦<span>Rooms</span></Link><Link href="/">♙<span>Tenants</span></Link><Link href="/">₹<span>Finance</span></Link></nav>
